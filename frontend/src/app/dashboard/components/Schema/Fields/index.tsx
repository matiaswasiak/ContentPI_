...
// Components
import DeleteFieldModal from '@modals/DeleteModelModal'
        ...
        {fields.map((field: any) => (
          ...
          >
            <div className={cx(styles.icon, styles[field.type])}>
              ...
              {field.type === 'String' && (
                <Icon title={field.description} type="fas fa-font" />
              )}
              {field.type === 'Text' && (
                <Icon title={field.description} type="fas fa-quote-right" />
              )}
              {field.type === 'Media' && (
                <Icon title={field.description} type="fas fa-image" />
              )}
              {field.type === 'Boolean' && (
